# Intégration SSO dans le repo — pose & déploiement
...
> (Optionnel) Le récap affiche encore « 3 étapes manuelles ». Tu peux remplacer ce passage par :
> ```bash
> if [ "${SSO_READY:-0}" = "1" ]; then
>   echo ">> ------------------------------------------------------------"
>   echo ">>  EirbConnect (SSO) : prêt et automatique."
>   echo ">>   - bouton EirbConnect sur https://$HOST"
>   echo ">>   - un membre inconnu se logge -> compte créé SANS groupe (en attente)"
